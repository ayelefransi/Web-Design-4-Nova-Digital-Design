      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <a href="#" className="text-2xl font-display font-bold text-white inline-block mb-4">
              <span className="text-gradient">Quantum</span> UI
            </a>
            <p className="text-foreground/70 max-w-md">
              We're passionate about creating exceptional digital experience that elevate brands and drive business growth.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#portfolio" className="text-foreground/70 hover:text-primary transition-colors">Portfolio</a>
              </li>
              <li>
        ...
        <div className="border-t border-border mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-foreground/70 text-sm">
            © {currentYear} Quantum UI. All rights reserved.
          </p>
